...
int main() {
  ...
  // Hint: make_layout(make_shape(Int<4>{}, Int<4>{}), make_stride(Int<8>{}, Int<1>{}))
  // START YOUR CODE HERE
  ...
  // ========================================================================
  // Goal: Modify an element through the slice and verify it changes the original
  ...
  std::cout << "1. How do you create a row slice? What's the stride?" << std::endl;
  std::cout << "2. How do you create a column slice? What's the stride?" << std::endl;
  std::cout << "3. Why are slices called 'views' and not 'copies'?" << std::endl;
  std::cout << "4. How do you calculate the offset for a sub-matrix?" << std::endl;
