 ...
 * 
 * Objective: Understand the difference between row-major and column-major layouts
 *            and how they affect memory access patterns
 * 
 * Tasks:
 ...
 * - Coalesced Access: When consecutive threads access consecutive memory addresses
 */
...
int main() {
    ...
    std::cout << "-> Consecutive? " 
              << (layout_rm(0,1) - layout_rm(0,0) == 1 ? "YES (COALESCED)" : "NO") 
              << std::endl;
    ...
    std::cout << "-> Consecutive? " 
              << (layout_rm(1,0) - layout_rm(0,0) == 1 ? "YES" : "NO (NOT COALESCED)") 
              << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "-> Consecutive? " 
              << (layout_cm(0,1) - layout_cm(0,0) == 1 ? "YES" : "NO (NOT COALESCED)") 
              << std::endl;
    ...
    std::cout << "-> Consecutive? " 
              << (layout_cm(1,0) - layout_cm(0,0) == 1 ? "YES (COALESCED)" : "NO") 
              << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "  Row-major layout(3, 2) = ? (Answer: " << layout_rm(3, 2) << ")" << std::endl;
    std::cout << "  Column-major layout(3, 2) = ? (Answer: " << layout_cm(3, 2) << ")" << std::endl;
    std::cout << std::endl;

    std::cout << "=== Exercise Complete ===" << std::endl;
    std::cout << "Key Learnings:" << std::endl;
    std::cout << "1. Row-major layouts have coalesced row access" << std::endl;
    std::cout << "2. Column-major layouts have coalesced column access" << std::endl;
    std::cout << "3. Same data, different memory ordering" << std::endl;
    std::cout << "4. Choose layout based on access pattern for best performance" << std::endl;
