...
// ============================================================================
__global__ void mixed_precision_gemm_kernel(half *gmem_A, half *gmem_B,
                                            float *gmem_C) {
  ...
  // Hint: auto C_gmem = make_tensor(make_gmem_ptr<float>(gmem_C),
  ...
  // Hint: using MMA_Atom = MMA_Atom<MMA_Traits<Shape<Int<16>, Int<8>, Int<16>>,
